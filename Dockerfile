...
COPY . /usr/local/openresty/gbc
RUN echo "GBC" \
    && bash -x /usr/local/openresty/gbc/gbc_alpine.sh /usr/local/openresty/gbc /usr/local/openresty/gbc \
&& rm -rf /usr/local/openresty/gbc/build /usr/local/openresty/gbc/.git \
&& apk del .build-deps
